...
export interface Game {
  id: 'rush2049' | 'rush1' | 'bm64' | 'bm64sa' | 'bmhero' | 'battletanx' | 'battletanxga' | 'gex64' | 'gex3' | 'yoshistory' | 'sf64' | 'goldeneye' | 'perfectdark' | 'oot' | 'mm' | 'oot-alpha' | 'pilotwings64' | 'pokemonsnap' | 'offroadchallenge' | 'airboarder64' | 'bugslife' | 'spiderman' | 'mk64' | 'shadows' | 'twine' | 'banjokazooie' | 'marioparty' | 'stuntracer64' | 'cruisnusa' | 'zelda-source';
  title: string;
  levels: LevelInfo[];
