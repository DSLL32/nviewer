...
export interface Game {
  id: 'rush2049' | 'rush1' | 'bm64' | 'bm64sa' | 'bmhero' | 'battletanx' | 'battletanxga' | 'gex64' | 'gex3' | 'yoshistory' | 'sf64' | 'goldeneye' | 'perfectdark' | 'oot' | 'mm' | 'oot-alpha' | 'pilotwings64' | 'pokemonsnap' | 'offroadchallenge' | 'airboarder64' | 'bugslife' | 'spiderman' | 'mk64' | 'kirby64' | 'glover' | 'shadows' | 'twine' | 'banjokazooie' | 'marioparty' | 'stuntracer64' | 'cruisnusa' | 'vigilante8' | 'vigilante8_2' | 'zelda-source';
  title: string;
  levels: LevelInfo[];
