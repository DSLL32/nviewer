// Collision overlays for the three Bomberman games (docs/BOMBERMAN_HERO.md,
// docs/BOMBERMAN64_SECOND_ATTACK.md, and docs/BOMBERMAN64.md).
// The overlays are translucent world-space triangles in a hidden "collision" layer, one mesh per surface type so
...
// ---- The Second Attack: collision file (scene descriptor +0x04), docs/BOMBERMAN64_SECOND_ATTACK.md ----
...
// ---- Bomberman Hero: collision planes in the stage blob, docs/BOMBERMAN_HERO.md ----
...
// ---- Bomberman 64: attribute grid, docs/BOMBERMAN64.md ----
