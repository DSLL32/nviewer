...
export type ControlAction = 'reset' | 'toggle-wireframe' | 'toggle-collision' | 'toggle-collision-wireframe' | 'toggle-help' | 'toggle-view' | 'toggle-cutaway';
