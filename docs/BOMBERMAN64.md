...
covers the 1 KiB token stream. The archive's size word and raw-file exceptions
are game-specific.
...
- **Drawable object pool** (verified from RAM, ROM analysis): 0x50-byte records from 0x800A0DF0.
