    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "Cruis'n USA", link: '/CRUISN_USA' },
          ...
          { text: 'Vigilante 8', link: '/VIGILANTE8' },
          { text: 'Vigilante 8: 2nd Offense', link: '/VIGILANTE8_2ND_OFFENSE' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Vigilante LZSS', link: '/compression/vigilante-lzss' },
          { text: "Cruis'n USA RLE", link: '/compression/cruisn-rle' },
