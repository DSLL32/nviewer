...
*Off Road Challenge* (USA and Europe), *Air Boarder 64* (Japan and Europe), *Pilotwings 64* (USA, Europe and Japan), *Pokémon Snap*, *A Bug's Life* (USA and Europe), *Spider-Man*, *Stunt Racer 64* (USA), *Cruis'n USA* (USA V1.0; scenery and music, without collision or traffic), *Star Wars: Shadows of the Empire* (USA V1.0–V1.2 and Europe), *007: The World Is Not Enough* (USA and Europe),
...
- `src/rom/`: ROM access and level decoding (no DOM dependencies; also runs under Node)
  ...
  - `bomberman/`: the Bomberman games (full format notes in `docs/BOMBERMAN64.md`,
    `docs/BOMBERMAN64_SECOND_ATTACK.md`, and `docs/BOMBERMAN_HERO.md`)
  ...
  - `gex/`: Gex 64 and Gex 3 (format notes in `docs/GEX64.md` and `docs/GEX3.md`)
  ...
  - `cruisnusa/`: Cruis'n USA (USA V1.0; format notes in `docs/CRUISN_USA.md`)
    - `catalog.ts`, `scene.ts`, `assets.ts`: asset catalog, 14 course graphs, meshes and textures
  ...
  - `zelda/`: Ocarina of Time and Majora's Mask (format notes in
    `docs/OCARINA_OF_TIME.md`, `docs/MAJORAS_MASK.md`, and
...
The three Bomberman manuals under `docs/` document the formats in full; in short:
...
`docs/GEX64.md` and `docs/GEX3.md` document the formats in full; in short:
...
The Ocarina of Time, Majora's Mask, and 1997 prototype manuals under `docs/`
document the formats in full; in short:
...
- **The 1997 prototype.** The upper half of an F-Zero X development ROM (`F-ZERO X [CFZE].z64`, identified by its SHA-1)
  ...
  backgrounds; actor ids are shifted by one from 0x24. The level list follows
  `docs/OCARINA_OF_TIME_1997_PROTOTYPE.md`, and each room's
